...
- (instancetype)initLoaderOnView:(UIView *)view {
    ...
    self.center = CGPointMake(CGRectGetMidX(view.bounds), view.bounds.size.height/3);
    ...
    self.loaderView.center = CGPointMake(CGRectGetWidth(self.frame)/2, view.bounds.size.height/2);
